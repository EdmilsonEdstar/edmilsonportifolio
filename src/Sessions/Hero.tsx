...
export function Hero(){
    ...
    O teu navegador não suporta vídeos.
            ...
            <div className=" my-5 mx-6">
                <div className="w-fit my-6 text-sm p-3 bg-gray-800/50 text-blue-400 rounded-2xl">
                ...
                <p className="w-fit my-6  text-sm leading-tight text-gray-400">
                ...
                <div className="flex py-6 text-sm">
                    <Link href="#" classN="flex w-fit bg-blue-400 text-white rounded-2xl py-3 px-6 mr-4 shadow-lg shadow-blue-500/50"><Send size={18} /><span className="pl-3">Contacto</span></Link> 
