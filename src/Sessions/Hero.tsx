            ...
            <div className="mb-5 pt-[5rem] mx-6  lg:flex  lg:justify-between lg:mx-[10rem] lg:gap-12 lg:pt-[10rem]">
                <div className="fade-in1">
                    ...
                    <div className="flex text-xl">
                        ...
                        <Link href="https://github.com/EdmilsonEdstar?tab=repositories" classN="w-fit my-6 text-sm p-3 bg-gray-800/50 text-blue-400 rounded-2xl mr-2"><Github size={15} /></Link> 
                        <Link href="https://www.linkedin.com/in/edmilson-ant%C3%B3nio-44a1b1266/" classN="w-fit my-6 text-sm p-3 bg-gray-800/50 text-blue-400 rounded-2xl"><Linkedin size={15} /></Link> 
                    </div>
                </div>
