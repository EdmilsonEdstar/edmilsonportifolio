...
<div className="lg:flex lg:justify-between lg:gap-6 text-xl text-center space-y-8 mb-12">
  <div className="lg:flex lg:justify-between lg:flex-wrap lg:gap-6 space-y-6">
    ...
    <p className="lg:w-[60%] text-left text-3xl lg:text-4xl font-bold leading-tight">
      <span className="text-orange-300 pr-2">Explore meus projetos,</span>
      <span className="italic">onde transformo ideias em aplicações React de alta performance, criando soluções funcionais e elegantes que atendem às necessidades reais dos usuários.</span>
    </p>
