    ...
    return(
        <div className="bg-gray-800/50 p-6 text-left space-y-4 rounded-xl lg:w-[35rem] lg:h-[35rem]">
            ...
            <div className="flex gap-4 text-gray-500">
                <Link href="#" children={<Github/>} classN="border border-gray-800 p-3 rounded-xl hover:text-blue-400 duration-300"/>
                <Link href="#" children={<ChevronRight/>} classN="border border-gray-800 p-3 rounded-xl hover:text-blue-400 duration-300"/>
            </div>
        </div>
    )
}